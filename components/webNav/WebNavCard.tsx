...
export default function WebNavCard({ name, thumbnail_url, title, url, content }: WebNavigation) {
  ...
  return (
    <div className='flex h-[210px] flex-col gap-3 rounded-xl bg-[#e6e6fa] p-1 lg:h-[343px]'>
      ...
      <div className='flex items-center justify-between px-[6px] text-[#3498db]'>
      ...
      <p className='line-clamp-3 px-[6px] text-xs text-[#333] lg:line-clamp-5 lg:text-sm'>{content}</p>
    </div>
  );
}
